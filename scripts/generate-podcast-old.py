...
GOOGLE_API_KEY = os.getenv("GOOGLE_API_KEY","AIzaSyDlhyPLL9m8kjnqvchW2NXLzMt5otMWdno")
AZURE_SPEECH_KEY = os.getenv("AZURE_SPEECH_KEY","FbjlhyvEkRrGvca1QdbHUZty3gFLKeaadBjE8ndSkPQXoJnE78RsJQQJ99BHACGhslBXJ3w3AAAYACOGSFms")
